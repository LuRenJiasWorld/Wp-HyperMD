...
Telegram Group : [WP HyperMD](https://t.me/wpeditormd)

== Installation ==

1. Upload the plugin files to the `/wp-content/plugins/plugin-name` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Use the Settings->HyperMD screen to configure the plugin
...
1. HyperMD Interface - Normal Mode
2. HyperMD Interface - Write Mode
3. HyperMD Interface - Full Screen Mode
